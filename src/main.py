...
# DATASETS_LIST = ['student_marks', 'yatch', 'housing', 'real_estate', 'concrete', 'triazines', 'stock', 'airfoild', 'wine_quality_red', 'abalone', 'wine_quality_white', 'ccpp', 'delta_elevators', 'bank8fm', 'puma8nh', 'puma32h', 'bank32nh']
DATASETS_LIST = ['student_marks', 'yatch', 'housing', 'real_estate', 'concrete', 'triazines', 'stock', 'airfoild', 'wine_quality_red', 'abalone', 'wine_quality_white', 'ccpp', 'delta_elevators', 'bank8fm', 'puma8nh', 'puma32h', 'bank32nh', 'liver']
